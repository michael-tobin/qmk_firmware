...
enum layers {
    _MAC_WM,     // MacOS Workman, default layer
    _WIN_WM,     // Windows Workman
...
enum tap_dance_codes {
    ...
    LYR_TO_WINWM_FUNC, // Layer tap goes to _WIN_WM, hold goes to _FUNC
    LYR_TO_MACWM_FUNC, // Layer tap goes to _MAC_WM, hold goes to _FUNC
    LYR_TO_WINWM_NUM,  // Layer tap goes to _WIN_WM, hold goes to _NUMPAD
    LYR_TO_MACWM_NUM,  // Layer tap goes to _MAC_WM, hold goes to _NUMPAD
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_MAC_WM] = LAYOUT_ergodox_pretty(
        ...
        KC_TAB,                 KC_Q,    KC_D,    KC_R,    KC_W,     B_BOLD,  KC_DELETE,            LGUI(KC_SPACE), KC_J,     F_FIND,       U_UNDLN,       P_PRINT, KC_SCOLON, KC_BSLASH,
        KC_CAPSLOCK,            KC_A,    S_SAVE,  KC_H,    T_TAB,    KC_G,                                          KC_Y,     N_NEW,        KC_E,          O_OPEN,  I_ITLCS,   QTPAIR,
        TD(DANCE_SFT_PRN),      Z_UNDO,  _X_CUT,   KC_M,    C_COPY,   V_PASTE, ENTER,                KC_SPACE,       K_HPRLNK, KC_L,         KC_COMMA,      KC_DOT,  KC_SLASH,  KC_RSPC,
        TD(LYR_TO_WINWM_NUM), KC_LALT, KC_LGUI, KC_LEFT, KC_RIGHT,                                                            TD(DANCE_UP), TD(DANCE_DWN), BRCPAIR, PRNPAIR,   TD(LYR_TO_MACQT_FUNC),
    ...
    */
    [_WIN_WM] = LAYOUT_ergodox_pretty(
        KC_NO,                 KC_NO,   KC_NO,    KC_NO,   KC_NO,    KC_NO,   KC_NO,          KC_NO,      KC_NO,    KC_NO,   KC_NO,    KC_NO,   KC_NO,   KC_NO,
        KC_TRNS,               KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,  B_BOLD,  KC_TRNS,        LGUI(KC_S), KC_TRNS,  F_FIND,  U_UNDLN,  P_PRINT, KC_TRNS, KC_TRNS,
        KC_TRNS,               KC_TRNS, S_SAVE,   KC_TRNS, KC_TRNS,  KC_TRNS,                             KC_TRNS,  N_NEW,   KC_TRNS,  O_OPEN,  I_ITLCS, KC_TRNS,
        KC_TRNS,               Z_UNDO,  _X_CUT,    KC_TRNS, C_COPY,   V_PASTE, KC_TRNS,        KC_TRNS,    K_HPRLNK, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,
        TD(LYR_TO_MACWM_NUM), KC_LGUI,  KC_LCTRL, KC_TRNS, KC_TRNS,                                                 KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, TD(LYR_TO_WINQT_FUNC),
    ...
    */
    [_MAC_QWERTY]  = LAYOUT_ergodox_pretty(
        ...
        TD(LYR_TO_WINQT_NUM), KC_LALT, KC_LGUI, KC_LEFT, KC_RIGHT,                                                     KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,   TD(LYR_TO_MACWM_FUNC), 
    ...
    */
    [_WIN_QWERTY] = LAYOUT_ergodox_pretty(
        ...
        KC_TRNS,              KC_A,    S_SAVE,  KC_D,    F_FIND,   KC_G,                                  KC_H,  KC_J,    K_HPRLNK, KC_L,    KC_SCOLON, QTPAIR,
        KC_TRNS,              Z_UNDO,  _X_CUT,   C_COPY,  V_PASTE,  B_BOLD, ENTER,             KC_TRNS,    N_NEW, KC_M,    KC_COMMA, KC_DOT,  KC_SLASH,  KC_RSPC,
        TD(LYR_TO_MACQT_NUM), KC_LALT, KC_LGUI, KC_LEFT, KC_RIGHT,                                               KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,   TD(LYR_TO_WINWM_FUNC), 
                                                                   KC_LGUI, KC_TRNS,          KC_TRNS, KC_TRNS,
                                                                            KC_TRNS,          KC_TRNS,
                                                          KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS
        ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case B_BOLD:
            if ((biton32(layer_state) == _MAC_WM) || (biton32(layer_state) == _MAC_QWERTY)) {
...
void lyr_to_winwm_func_finished(qk_tap_dance_state_t *state, void *user_data);
void lyr_to_winwm_func_reset(qk_tap_dance_state_t *state, void *user_data);
...
void lyr_to_macwm_func_finished(qk_tap_dance_state_t *state, void *user_data);
void lyr_to_macwm_func_reset(qk_tap_dance_state_t *state, void *user_data);
...
void lyr_to_winwm_num_finished(qk_tap_dance_state_t *state, void *user_data);
void lyr_to_winwm_num_reset(qk_tap_dance_state_t *state, void *user_data);
...
void lyr_to_macwm_num_finished(qk_tap_dance_state_t *state, void *user_data);
void lyr_to_macwm_num_reset(qk_tap_dance_state_t *state, void *user_data);
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [LYR_TO_WINWM_FUNC] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, lyr_to_winwm_func_finished, lyr_to_winwm_func_reset),
    [LYR_TO_MACWM_FUNC] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, lyr_to_macwm_func_finished, lyr_to_macwm_func_reset),
    [LYR_TO_WINWM_NUM]  = ACTION_TAP_DANCE_FN_ADVANCED(NULL, lyr_to_winwm_num_finished, lyr_to_winwm_num_reset),
    [LYR_TO_MACWM_NUM]  = ACTION_TAP_DANCE_FN_ADVANCED(NULL, lyr_to_macwm_num_finished, lyr_to_macwm_num_reset),
