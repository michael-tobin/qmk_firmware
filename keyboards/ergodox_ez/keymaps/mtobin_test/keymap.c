 ...
 /* _MAC_CM: MacOS Colemak DH Layer (Blue LED)
    ...
    */
    [_MAC_CM] = LAYOUT_ergodox_pretty(
        ...
        STORE_SETUPS,               KC_Q,    KC_W,    F_FIND,  P_PRINT,  B_BOLD,  KC_DELETE,            LGUI(KC_SPACE), KC_J,     KC_L,   U_UNDLN,  KC_Y,    KC_SCOLON, KC_BSLASH,
        PRINT_SETUPS,          KC_A,    KC_R,    S_SAVE,  T_TAB,    KC_G,                                          KC_M,     N_NEW,  KC_E,     I_ITLCS, O_OPEN,    QTPAIR,
